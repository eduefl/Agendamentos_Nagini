...
class UserPresenter:
    ...
    @toJSON.register
    @staticmethod
    def _(user_dto: ActivateUserOutputDTO) -> dict:
        return {
            "id": str(user_dto.id),
            "name": user_dto.name,
            "email": str(getattr(user_dto, "email", "")) if getattr(user_dto, "email", None) is not None else None,
    ...
    @toJSON.register
    @staticmethod
    def _(user_dto: AddPrestadorOutputDTO) -> dict:
        return {
            "id": str(user_dto.id),
            "name": user_dto.name,
            "email": str(getattr(user_dto, "email", "")) if getattr(user_dto, "email", None) is not None else None,
    ...
    @toXml.register
    @staticmethod
    def _(user_dto: ActivateUserOutputDTO) -> str:
        user_data = ET.Element("user")
        ET.SubElement(user_data, "id").text = str(user_dto.id)
        ET.SubElement(user_data, "name").text = str(user_dto.name)
    ...
    @toXml.register
    @staticmethod
    def _(user_dto: AddPrestadorOutputDTO) -> str:
        user_data = ET.Element("user")
        ET.SubElement(user_data, "id").text = str(user_dto.id)
        ET.SubElement(user_data, "name").text = str(user_dto.name)
