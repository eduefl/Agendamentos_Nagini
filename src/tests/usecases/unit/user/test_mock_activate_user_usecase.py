...
class TestMockActivateUserUseCase:
    def test_activate_user_usecase_sucess(self):
        ...
        use_case = ActivateUserUseCase(
            password_hasher=mock_hasher, user_repository=mock_user
        )

        input_dto = ActivateUserInputDTO(email=email_in, activation_code="abc12345")
        ...
        mock_hasher.verify.assert_called_once_with(
            password="abc12345", hashed_password="hashed12345"
        )
    ...
    def test_activate_user_usecase_code_expires_None(self):
        ...
        input_dto = ActivateUserInputDTO(email=email_in, activation_code="hashed12345")
    ...
    def test_activate_user_usecase_ActivationCodeExpiredError(self):
        ...
        mock_user.find_user_by_email.return_value = User(
            ...
            - timedelta(minutes=1),  # Code expired
            roles={"cliente"},
        )
        mock_hasher.verify.return_value = True
    ...
    def test_activate_user_usecase_InvalidActivationCodeError(self):
        ...
        input_dto = ActivateUserInputDTO(email=email_in, activation_code="invalid_code")
        ...
        mock_user.find_user_by_email.assert_called_once_with(email=email_in)
        mock_hasher.verify.assert_called_once_with(
            password="invalid_code", hashed_password="hashed12345"
        )
        mock_user.update_user.assert_not_called()
