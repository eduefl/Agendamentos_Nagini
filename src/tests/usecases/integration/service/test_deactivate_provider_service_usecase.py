...
class TestDeactivateProviderServiceUseCaseIntegration:
    ...
    def test_deactivate_provider_service_user_not_found(
        self,
        tst_db_session,
    ):
        session = tst_db_session
    ...
    def test_deactivate_provider_service_provider_inactive(
        self,
        tst_db_session,
        make_user,
        seed_roles,
    ...
    def test_deactivate_provider_service_user_not_provider(
        self,
        tst_db_session,
        make_user,
        seed_roles,
    ...
    def test_deactivate_provider_service_not_found(
        self,
        tst_db_session,
        make_user,
        seed_roles,
    ...
    def test_deactivate_provider_service_from_another_provider(
        self,
        tst_db_session,
        make_user,
        make_provider_service,
    ...
    def test_deactivate_provider_service_already_inactive(
        self,
        tst_db_session,
        make_user,
        make_provider_service,
