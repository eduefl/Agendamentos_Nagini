...
class TestAddProviderRoute:
    def test_add_provider_route_success(self, client: TestClient, tst_db_session, make_user, seed_roles):
        response = client.post("/users/providers/", json={
			"name": "John Doe",
    ...
    def test_add_provider_route_email_already_exist(self, client: TestClient, tst_db_session, make_user, seed_roles):
    ...
    def test_add_provider_route_invalid_email(self, client: TestClient, tst_db_session, make_user, seed_roles):
        response = client.post("/users/providers/", json={
			"name": "John Doe",
    ...
    def test_add_provider_route_password_empty(self, client: TestClient, tst_db_session, make_user, seed_roles):
        response = client.post("/users/providers/", json={
            "name": "John Doe",
            "email": "john.doe@example.com",
            "password": ""
